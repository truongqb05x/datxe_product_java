<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
            ...
            <div class="header-container">
                ...
                <div class="user-avatar" id="userAvatar" style="display: none;">
                    ...
                    <div class="user-dropdown">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/trangcanhan.jsp"><i class="fas fa-user"></i>
                                    Thông tin tài khoản</a></li>
                            <li><a href="${pageContext.request.contextPath}/lichsu.jsp"><i class="fas fa-history"></i>
                                    Lịch sử thuê xe</a></li>
                            <li><a href="${pageContext.request.contextPath}/yeuthich.jsp"><i class="fas fa-heart"></i>
                                    Xe yêu thích</a></li>
                            <li class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/logout"><i class="fas fa-sign-out-alt"></i>
                                    Đăng xuất</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <form class="auth-form" id="registerForm" action="${pageContext.request.contextPath}/register"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="password" id="registerPassword" name="password" placeholder="Tạo mật khẩu"
                                required>
                        </div>
        ...
        <section class="page-header">
            ...
            <p>Khám phá bộ sưu tập xe máy đa dạng của chúng tôi, từ xe phổ thông đến cao cấp, phù hợp với mọi nhu cầu di
                chuyển của bạn.</p>
        </section>
            ...
            <div class="motorcycles-grid">
                ...
                <div class="motorcycle-card">
                    <div class="motorcycle-img">
                        <img src="https://images.unsplash.com/photo-1609630875171-b1321377ee65?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1480&q=80"
                            alt="Honda Vision">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('honda-vision')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
                ...
                <div class="motorcycle-card">
                    <div class="motorcycle-img">
                        <img src="https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Yamaha Exciter">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('yamaha-exciter')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
                ...
                <div class="motorcycle-card">
                    <div class="motorcycle-img">
                        <img src="https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Honda SH">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('honda-sh')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
                ...
                <div class="motorcycle-card">
                    <div class="motorcycle-img">
                        <img src="https://images.unsplash.com/photo-1571068316344-75bc76f77890?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Yamaha Sirius">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('yamaha-sirius')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
                ...
                <div class="motorcycle-card">
                    <div class="motorcycle-img">
                        <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Honda Wave">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('honda-wave')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
                ...
                <div class="motorcycle-card">
                    ...
                    <div class="motorcycle-content">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 0.5rem;"
                            onclick="openVehicleModal('piaggio-liberty')">Chi tiết xe</button>
                        <button class="btn btn-outline" style="width: 100%;"
                            onclick="location.href='${pageContext.request.contextPath}/pages/datxe.jsp'">Thuê
                            ngay</button>
