        ...
        <div class="header-container">
            ...
            <div class="user-avatar" id="userAvatar" style="display: none;">
                ...
                <div class="user-dropdown">
                    <ul>
                        <li><a href="profile.html" class="active"><i class="fas fa-user"></i> Thông tin tài khoản</a></li>
                        <li><a href="history.html"><i class="fas fa-history"></i> Lịch sử thuê xe</a></li>
