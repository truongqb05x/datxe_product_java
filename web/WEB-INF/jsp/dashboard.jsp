...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                ...
                <ul class="nav-dropdown" id="vehicle-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/vehicles" class="nav-link"><i class="fas fa-list"></i> Tất cả xe</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/vehicles/add" class="nav-link"><i class="fas fa-plus"></i> Thêm xe mới</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/vehicles/locations" class="nav-link"><i class="fas fa-map-marker-alt"></i> Vị trí xe</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/categories" class="nav-link"><i class="fas fa-tags"></i> Danh mục</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/brands" class="nav-link"><i class="fas fa-copyright"></i> Thương hiệu</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-dropdown" id="booking-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/bookings" class="nav-link"><i class="fas fa-list"></i> Tất cả đơn</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/bookings?status=PENDING" class="nav-link"><i class="fas fa-clock"></i> Đang chờ</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/bookings?status=CONFIRMED" class="nav-link"><i class="fas fa-check-circle"></i> Đã xác nhận</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/bookings?status=CANCELLED" class="nav-link"><i class="fas fa-times-circle"></i> Đã hủy</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-dropdown" id="user-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/users" class="nav-link"><i class="fas fa-user-friends"></i> Tất cả người dùng</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/users/add" class="nav-link"><i class="fas fa-user-plus"></i> Thêm người dùng</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/verifications" class="nav-link"><i class="fas fa-id-card"></i> Xác thực giấy tờ</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/reviews" class="nav-link"><i class="fas fa-comments"></i> Phản hồi & Đánh giá</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-dropdown" id="report-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/reports/revenue" class="nav-link"><i class="fas fa-chart-line"></i> Doanh thu</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/reports/analytics" class="nav-link"><i class="fas fa-chart-pie"></i> Phân tích</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/reports/export" class="nav-link"><i class="fas fa-file-export"></i> Xuất báo cáo</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-dropdown" id="content-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/blog" class="nav-link"><i class="fas fa-blog"></i> Bài viết</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/contacts" class="nav-link"><i class="fas fa-envelope"></i> Liên hệ</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/chatbot" class="nav-link"><i class="fas fa-comments"></i> Chatbot</a></li>
                </ul>
            </li>
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                <div class="user-avatar">${not empty sessionScope.user.fullName ? sessionScope.user.fullName.charAt(0) : 'A'}</div>
                <div>
    ...
    <main class="main-content">
            ...
            <div class="header-right">
                ...
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="${pageContext.request.contextPath}/admin/profile"><i class="fas fa-user"></i> Hồ sơ</a>
                        <a href="${pageContext.request.contextPath}/admin/settings"><i class="fas fa-cog"></i> Cài đặt</a>
        ...
        <div class="stats-cards">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-value">
                        <fmt:formatNumber value="${dashboardStats.monthlyRevenue}" type="currency" currencySymbol="₫" maxFractionDigits="0"/>
                    </div>
                    <div class="stat-change ${dashboardStats.revenueChange >= 0 ? 'positive' : 'negative'}">
                        <i class="fas fa-${dashboardStats.revenueChange >= 0 ? 'arrow-up' : 'arrow-down'}"></i>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-change ${dashboardStats.bookingChange >= 0 ? 'positive' : 'negative'}">
                        <i class="fas fa-${dashboardStats.bookingChange >= 0 ? 'arrow-up' : 'arrow-down'}"></i>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-change ${dashboardStats.maintenanceVehicles > 0 ? 'negative' : 'positive'}">
                        <i class="fas fa-${dashboardStats.maintenanceVehicles > 0 ? 'arrow-down' : 'arrow-up'}"></i>
        ...
        <div class="tables-row">
            <div class="table-container">
                <div class="table-header">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/bookings" class="btn-view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody id="recentBookingsTable">
                        <c:forEach var="booking" items="${recentBookings}">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/admin/bookings/${booking.id}" class="btn-view">Xem</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/vehicles" class="btn-view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody id="popularVehiclesTable">
                        <c:forEach var="vehicle" items="${popularVehicles}">
                            <tr>
                                ...
                                <td>
                                    <fmt:formatNumber value="${vehicle.revenue}" type="currency" currencySymbol="₫" maxFractionDigits="0"/>
                                </td>
                                <td>⭐ ${vehicle.rating} (${vehicle.reviewCount})</td>
                                <td>
                                    <c:choose>
                                        <c:when test="${vehicle.status == 'AVAILABLE'}">
                                            <span class="status-badge status-confirmed">Đang hoạt động</span>
                                        </c:when>
                                        ...
                                        <c:when test="${vehicle.status == 'UNAVAILABLE'}">
                                            <span class="status-badge status-cancelled">Không khả dụng</span>
                                        </c:when>
                                    </c:choose>
                                </td>
                            </tr>
        ...
        <!-- Footer -->
        <footer class="footer">
            <p>© 2023 RentCar Admin Dashboard. Phiên bản ${appVersion} | <span id="currentDateTime"></span></p>
        </footer>
    </main>
