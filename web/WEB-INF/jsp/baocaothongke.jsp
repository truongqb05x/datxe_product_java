                            ...
                            <div class="filter-grid">
                                <div class="filter-group">
                                    ...
                                    <select id="reportPeriod" name="period">
                                        <option value="monthly" ${param.period eq 'monthly' ? 'selected' : '' }>Theo
                                            tháng</option>
                                        <option value="quarterly" ${param.period eq 'quarterly' ? 'selected' : '' }>Theo
                                            quý</option>
                                        <option value="yearly" ${param.period eq 'yearly' ? 'selected' : '' }>Theo năm
                                        </option>
                                        <option value="custom" ${param.period eq 'custom' ? 'selected' : '' }>Tùy chỉnh
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="filter-group">
                                    ...
                                    <select id="reportCategory" name="category">
                                        ...
                                        <option value="motorcycle" ${param.category eq 'motorcycle' ? 'selected' : '' }>
                                            Xe máy</option>
                                        <option value="electric" ${param.category eq 'electric' ? 'selected' : '' }>Xe
                                            điện</option>
                                ...
                                <div class="filter-group">
                                    ...
                                    <select id="reportMetrics" name="metrics">
                                        <option value="revenue" ${param.metrics eq 'revenue' ? 'selected' : '' }>Doanh
                                            thu</option>
                                        <option value="bookings" ${param.metrics eq 'bookings' ? 'selected' : '' }>Số
                                            đơn đặt</option>
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-details">
                                                ...
                                                <p>${vehicle.bookings} đơn •
                                                    <fmt:formatNumber value="${vehicle.utilization}" pattern="0.0" />%
                                                    sử dụng
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <td>
                                                    <div class="progress-bar">
                                                        <div class="progress-fill progress-primary"
                                                            style="width: ${Math.min(100, item.growth + 20)}%"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    ...
                                    <tbody id="categoryTableBody">
                                        <c:forEach var="category" items="${categoryData}">
                                            <tr>
                                                ...
                                                <td>
                                                    <fmt:formatNumber value="${category.percentage}" pattern="0.0" />%
                                                </td>
                        ...
                        <div class="insights-grid">
                            <div class="insight-card success">
                                ...
                                <div class="insight-content">
                                    <p>Doanh thu tháng ${currentMonth} tăng <strong>${revenueChange}%</strong> so với
                                        tháng trước.
                    ...
                    <div class="modal" id="loadingModal" style="background: rgba(255, 255, 255, 0.9);">
                        <div class="modal-content" style="max-width: 400px; background: transparent; box-shadow: none;">
                            <div class="modal-body" style="text-align: center;">
                                <div class="spinner"
                                    style="width: 60px; height: 60px; border-width: 6px; margin: 0 auto 1.5rem;"></div>
                                    ...
                                    <div style="display: grid; gap: 1.5rem;">
                                        ...
                                        <div class="filter-group">
                                            ...
                                            <div
                                                ...
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="metrics" value="revenue" checked> Doanh
                                                    thu
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="metrics" value="bookings" checked> Số
                                                    đơn đặt
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="metrics" value="vehicles" checked> Hiệu
                                                    suất xe
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                ...
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="metrics" value="utilization"> Tỷ lệ sử
                                                    dụng
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        ...
                                        <div class="filter-group">
                                            ...
                                            <div style="display: grid; gap: 0.5rem;">
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="includeCharts" id="includeCharts"> Bao
                                                    gồm biểu đồ
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="includeInsights" id="includeInsights">
                                                    Bao gồm insights
                                                </label>
                                                <label style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <input type="checkbox" name="scheduleReport" id="scheduleReport">
