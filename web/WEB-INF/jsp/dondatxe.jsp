                    ...
                    <main class="main-content">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="totalBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.totalBookings}">${stats.totalBookings}
                                            </c:when>
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="pendingBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.pendingBookings}">${stats.pendingBookings}
                                            </c:when>
                                            <c:otherwise>0</c:otherwise>
                                        </c:choose>
                                    </div>
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="confirmedBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.confirmedBookings}">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="activeBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.activeBookings}">${stats.activeBookings}
                                            </c:when>
                                            <c:otherwise>0</c:otherwise>
                                        </c:choose>
                                    </div>
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="completedBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.completedBookings}">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-info">
                                    ...
                                    <div class="stat-value" id="cancelledBookings">
                                        <c:choose>
                                            <c:when test="${not empty stats.cancelledBookings}">
                        ...
                        <section class="calendar-view" id="calendarView">
                            <div class="calendar-header">
                                <h3><i class="fas fa-calendar"></i> Lịch đặt xe <span id="calendarMonthYear">Tháng
                                        12/2023</span></h3>
                        ...
                        <section class="filters-section">
                            <div class="filters-header">
                                ...
                                <div class="quick-actions">
                                    <button
                                        class="action-btn ${empty param.status or param.status == 'all' ? 'active' : ''}"
                                        data-status="all">
                                        <i class="fas fa-list"></i> Tất cả
                                    </button>
                                    <button class="action-btn ${param.status == 'PENDING' ? 'active' : ''}"
                                        data-status="PENDING">
                                        <i class="fas fa-clock"></i> Chờ xác nhận
                                    </button>
                                    <button class="action-btn ${param.status == 'CONFIRMED' ? 'active' : ''}"
                                        data-status="CONFIRMED">
                                        <i class="fas fa-check-circle"></i> Đã xác nhận
                                    </button>
                                    <button class="action-btn ${param.status == 'ACTIVE' ? 'active' : ''}"
                                        data-status="ACTIVE">
                                        <i class="fas fa-car"></i> Đang hoạt động
                                    </button>
                                    <button class="action-btn ${param.status == 'COMPLETED' ? 'active' : ''}"
                                        data-status="COMPLETED">
                                        <i class="fas fa-flag-checkered"></i> Đã hoàn thành
                                    </button>
                                    <button class="action-btn ${param.status == 'CANCELLED' ? 'active' : ''}"
                            ...
                            <div class="filter-grid">
                                ...
                                <div class="filter-group">
                                    ...
                                    <select id="filterPayment">
                                        ...
                                        <option value="PAID" ${param.paymentStatus=='PAID' ? 'selected' : '' }>Đã thanh
                                            toán
                                        </option>
                                        <option value="PARTIAL" ${param.paymentStatus=='PARTIAL' ? 'selected' : '' }>
                                            Thanh
                                            toán một phần</option>
                                        <option value="UNPAID" ${param.paymentStatus=='UNPAID' ? 'selected' : '' }>Chưa
                                            thanh toán</option>
                                        <option value="REFUNDED" ${param.paymentStatus=='REFUNDED' ? 'selected' : '' }>
                                            Đã
                                            hoàn tiền</option>
                                    </select>
                                </div>
                        ...
                        <div class="bookings-table-container">
                            <div class="table-toolbar">
                                <div class="table-info">
                                    Hiển thị <span id="tableCount">${bookings.size()}</span> trên tổng số <span
                                        id="tableTotal">${stats.totalBookings}</span> đơn đặt
                                </div>
                                ...
                                <table id="bookingsTable" class="display">
                                    ...
                                    <tbody id="bookingsTableBody">
                                        <c:forEach var="booking" items="${bookings}">
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="select-checkbox select-booking"
                                                        data-id="${booking.id}">
                                                </td>
                                                <td>
                                                ...
                                                <td class="vehicle-info">
                                                    ...
                                                    <div class="vehicle-details">${booking.vehicle.licensePlate} •
                                                        ${booking.vehicle.color}</div>
                                                    <div class="vehicle-details">
                                                        <fmt:formatNumber value="${booking.vehicle.dailyRate}"
                                                ...
                                                <td class="date-info">
                                                    <div class="date-range">
                                                        <fmt:formatDate value="${booking.pickupDate}"
                                                            pattern="dd/MM/yyyy" />
                                                        →
                                                        <fmt:formatDate value="${booking.returnDate}"
                                                            pattern="dd/MM/yyyy" />
                                                    </div>
                                                    <div class="days-count">${booking.totalDays} ngày
                                                        (${booking.totalHours}
                                                        giờ)</div>
                                                </td>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${booking.status == 'COMPLETED'}">
                                                            <span class="status-badge status-completed">Đã hoàn
                                                                thành</span>
                                                        </c:when>
                                                        ...
                                                        <c:otherwise>
                                                            <span
                                                                class="status-badge status-pending">${booking.status}</span>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${booking.paymentStatus == 'PAID'}">
                                                            <span class="payment-badge payment-paid">Đã thanh
                                                                toán</span>
                                                        </c:when>
                                                        <c:when test="${booking.paymentStatus == 'PARTIAL'}">
                                                            <span class="payment-badge payment-partial">Thanh toán một
                                                                phần</span>
                                                        </c:when>
                                                        <c:when test="${booking.paymentStatus == 'UNPAID'}">
                                                            <span class="payment-badge payment-unpaid">Chưa thanh
                                                                toán</span>
                                                        </c:when>
                                                        <c:when test="${booking.paymentStatus == 'REFUNDED'}">
                                                            <span class="payment-badge payment-refunded">Đã hoàn
                                                                tiền</span>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <span
                                                                class="payment-badge payment-unpaid">${booking.paymentStatus}</span>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>
                                                    <div class="action-buttons">
                                                        <button class="action-btn-small view-booking"
                                                            data-id="${booking.id}" title="Xem chi tiết">
                                                            <i class="fas fa-eye"></i>
                                                        </button>
                                                        <button class="action-btn-small edit-booking"
                                                            data-id="${booking.id}" title="Chỉnh sửa">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <c:if test="${booking.status == 'PENDING'}">
                                                            <button class="action-btn-small confirm-booking"
                                                                data-id="${booking.id}" title="Xác nhận đơn">
                                                                <i class="fas fa-check-circle"></i>
                                                            </button>
                                                        </c:if>
                                                        <c:if
                                                            test="${booking.status != 'CANCELLED' && booking.status != 'COMPLETED'}">
                                                            <button class="action-btn-small delete-booking"
                                                                data-id="${booking.id}" title="Hủy đơn">
                                    ...
                                    <div class="booking-detail-grid">
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="info-grid">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value booking-code" id="detailBookingCode">
                                                            RENT20230045</div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Ngày đặt</div>
                                                        <div class="info-value" id="detailBookingDate">05/12/2023 14:30
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value">
                                                            <span class="status-badge status-confirmed"
                                                                id="detailBookingStatus">Đã xác nhận</span>
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value">
                                                            <span class="payment-badge payment-paid"
                                                                id="detailPaymentStatus">Đã thanh toán</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="info-grid">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value" id="detailCustomerName">Nguyễn Văn A
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Số điện thoại</div>
                                                        <div class="info-value" id="detailCustomerPhone">0912345678
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Email</div>
                                                        <div class="info-value" id="detailCustomerEmail">
                                                            nguyenvana@email.com</div>
                                                    </div>
                                                    <div class="info-item">
                                                    ...
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value" id="detailCustomerLicense">A1234567 -
                                                            Hạng
                                                            B2</div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Địa chỉ</div>
                                                        <div class="info-value" id="detailCustomerAddress">123 Đường
                                                            ABC,
                                                            Quận 1, TP.HCM</div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="info-grid">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value" id="detailVehicleName">Toyota Vios 2023
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="info-grid">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value" id="detailPickupDate">15/12/2023 08:00
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Ngày trả xe</div>
                                                        <div class="info-value" id="detailReturnDate">20/12/2023 18:00
                                                        </div>
                                                    </div>
                                                    <div class="info-item">
                                                    ...
                                                    <div class="info-item">
                                                        ...
                                                        <div class="info-value" id="detailPickupLocation">123 Đường ABC,
                                                            Quận 1, TP.HCM</div>
                                                    </div>
                                                    <div class="info-item">
                                                        <div class="info-label">Điểm trả xe</div>
                                                        <div class="info-value" id="detailReturnLocation">456 Đường XYZ,
                                                            Quận 3, TP.HCM</div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                                ...
                                                <div class="timeline">
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-time" id="timelineCreated">05/12/2023
                                                                14:30
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-time" id="timelineConfirmed">05/12/2023
                                                                16:15</div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-time" id="timelinePayment">Chờ thanh
                                                                toán
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-time" id="timelinePickup">15/12/2023
                                                                08:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-time" id="timelineCompleted">20/12/2023
                                                                18:00</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div id="bookingNotes"
                                                    style="background: #f8f9fa; padding: 1rem; border-radius: 6px; font-size: 0.9rem; color: #666;">
                                                    Khách hàng yêu cầu chuẩn bị xe sạch sẽ, đầy đủ nhiên liệu. Giao xe
                                                    tại
                        ...
                        <div class="modal" id="bookingFormModal">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="bookingForm"
                                        action="${pageContext.request.contextPath}/admin/bookings/save" method="POST">
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                                                    ...
                                                    <div class="info-grid">
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <button type="button" class="btn btn-outline"
                                                                id="newCustomerBtn" style="width: 100%;">
                                                ...
                                                <div class="detail-section">
                                                    ...
                                                    <div class="info-grid">
                                                            ...
                                                            <select id="vehicleSelect" name="vehicleId" required>
                                                                ...
                                                                <c:forEach var="vehicle" items="${vehicles}">
                                                                    <option value="${vehicle.id}"
                                                                        ...
                                                                        ${vehicle.name} (${vehicle.licensePlate}) -
                                                                        <fmt:formatNumber value="${vehicle.dailyRate}"
                                                                            type="currency" currencyCode="VND" />
                                                                        /ngày
                                                                    </option>
                                                                </c:forEach>
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <input type="text" id="vehicleAvailability" value="Có sẵn"
                                                ...
                                                <div class="detail-section">
                                                    ...
                                                    <div class="info-grid">
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <input type="text" id="totalDays" value="0 ngày" readonly
                                                                style="background: #f5f5f5;">
                                                        </div>
                                                        <div class="info-item">
                                                            <label for="totalHours">Tổng số giờ</label>
                                                            <input type="text" id="totalHours" value="0 giờ" readonly
                                                                style="background: #f5f5f5;">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                                    ...
                                                    <div class="info-grid">
                                                        <div class="info-item">
                                                            ...
                                                            <select id="pickupLocation" name="pickupLocation" required>
                                                                ...
                                                                <option value="3">Chi nhánh sân bay Tân Sơn Nhất
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="info-item">
                                                ...
                                                <div class="detail-section">
                                                    ...
                                                    <div class="price-breakdown">
                                                        <div class="price-item">
                                                            ...
                                                            <input type="hidden" id="baseAmount" name="baseAmount"
                                                                value="0">
                                                        </div>
                                                        <div class="price-item">
                                                            <span>Phí bảo hiểm (20%):</span>
                                                            <span id="calcInsurance">0 ₫</span>
                                                            <input type="hidden" id="insuranceFee" name="insuranceFee"
                                                                value="0">
                                                        </div>
                                                        <div class="price-item">
                                                            <span>Phí dịch vụ:</span>
                                                        ...
                                                        <div class="price-item">
                                                            ...
                                                            <div style="display: flex; gap: 0.5rem;">
                                                                <input type="text" id="discountCode"
                                                                    placeholder="Nhập mã" style="flex: 1;">
                                                                <button type="button" class="btn btn-outline"
                                                                    id="applyDiscount">Áp dụng</button>
                                                            </div>
                                                        </div>
                                                        <div class="price-item">
                                                            <span>Giảm giá:</span>
                                                ...
                                                <div class="detail-section">
                                                    <h4>Ghi chú</h4>
                                                    <textarea id="bookingNotesField" name="notes" rows="4"
                                                        placeholder="Ghi chú về đơn đặt..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div id="loadingOverlay" class="modal" style="background: rgba(0,0,0,0.5); display: none;">
                            <div class="modal-content"
                                style="max-width: 200px; text-align: center; background: transparent; box-shadow: none;">
